...
Version  : 1.6.2
Release  : 31
URL      : https://github.com/intel/QAT_Engine/archive/v1.6.2/QAT_Engine-1.6.2.tar.gz
Source0  : https://github.com/intel/QAT_Engine/archive/v1.6.2/QAT_Engine-1.6.2.tar.gz
...
%prep
%setup -q -n QAT_Engine-1.6.2
cd %{_builddir}/QAT_Engine-1.6.2
pushd ..
cp -a QAT_Engine-1.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724843430
