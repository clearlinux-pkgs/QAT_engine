...
Source0  : https://github.com/intel/QAT_Engine/archive/v0.6.18/QAT_Engine-0.6.18.tar.gz
...
%prep
%setup -q -n QAT_Engine-0.6.18
cd %{_builddir}/QAT_Engine-0.6.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671040197
