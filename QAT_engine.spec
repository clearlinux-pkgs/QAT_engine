...
%prep
%setup -q -n QAT_Engine-1.9.0
cd %{_builddir}/QAT_Engine-1.9.0
pushd ..
cp -a QAT_Engine-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743172328
...
cp %{_builddir}/QAT_Engine-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/QAT_engine/151ddec97a6d91b3c592754f4d1425edf8938163 || :
...
cp %{_builddir}/QAT_Engine-%{version}/LICENSE.PLOCK %{buildroot}/usr/share/package-licenses/QAT_engine/b0b50cc4e4acc9a7f4224cfa7ddaf723db9f0397 || :
...
/usr/share/package-licenses/QAT_engine/151ddec97a6d91b3c592754f4d1425edf8938163
/usr/share/package-licenses/QAT_engine/780e9c21e5fcb60d7580ef142cca50fbfd16d194
/usr/share/package-licenses/QAT_engine/b0b50cc4e4acc9a7f4224cfa7ddaf723db9f0397
