...
Version  : 0.6.12
Release  : 9
URL      : https://github.com/intel/QAT_Engine/archive/v0.6.12/QAT_Engine-0.6.12.tar.gz
Source0  : https://github.com/intel/QAT_Engine/archive/v0.6.12/QAT_Engine-0.6.12.tar.gz
...
%prep
%setup -q -n QAT_Engine-0.6.12
cd %{_builddir}/QAT_Engine-0.6.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648826156
...
cp %{_builddir}/QAT_Engine-0.6.12/LICENSE %{buildroot}/usr/share/package-licenses/QAT_engine/077140cc63b33bd8d34df92c358f3056e63f6f43
cp %{_builddir}/QAT_Engine-0.6.12/LICENSE.OPENSSL3.0 %{buildroot}/usr/share/package-licenses/QAT_engine/c5c8a68f4b80929b3e66f054f37bb9e16078847f
cp %{_builddir}/QAT_Engine-0.6.12/qat/LICENSE.GPL %{buildroot}/usr/share/package-licenses/QAT_engine/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/QAT_Engine-0.6.12/qat_contig_mem/LICENSE.GPL %{buildroot}/usr/share/package-licenses/QAT_engine/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
