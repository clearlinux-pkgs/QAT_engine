...
Version  : 0.6.17
Release  : 16
URL      : https://github.com/intel/QAT_Engine/archive/v0.6.17/QAT_Engine-0.6.17.tar.gz
Source0  : https://github.com/intel/QAT_Engine/archive/v0.6.17/QAT_Engine-0.6.17.tar.gz
...
%prep
%setup -q -n QAT_Engine-0.6.17
cd %{_builddir}/QAT_Engine-0.6.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667486652
