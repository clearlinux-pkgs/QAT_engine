...
Source0  : https://github.com/intel/QAT_Engine/archive/v1.6.0/QAT_Engine-1.6.0.tar.gz
...
%prep
%setup -q -n QAT_Engine-1.6.0
cd %{_builddir}/QAT_Engine-1.6.0
pushd ..
cp -a QAT_Engine-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711465102
