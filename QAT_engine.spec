...
Version  : 0.6.11
Release  : 8
URL      : https://github.com/intel/QAT_Engine/archive/v0.6.11/QAT_Engine-0.6.11.tar.gz
Source0  : https://github.com/intel/QAT_Engine/archive/v0.6.11/QAT_Engine-0.6.11.tar.gz
Summary  : Intel QuickAssist Technology (QAT) OpenSSL Engine
Group    : Development/Tools
License  : Apache-2.0 GPL-2.0 OpenSSL
...
%prep
%setup -q -n QAT_Engine-0.6.11
cd %{_builddir}/QAT_Engine-0.6.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643304725
...
cp %{_builddir}/QAT_Engine-0.6.11/LICENSE.OPENSSL3.0 %{buildroot}/usr/share/package-licenses/QAT_engine/c5c8a68f4b80929b3e66f054f37bb9e16078847f
cp %{_builddir}/QAT_Engine-0.6.11/qat/LICENSE.GPL %{buildroot}/usr/share/package-licenses/QAT_engine/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/QAT_Engine-0.6.11/qat_contig_mem/LICENSE.GPL %{buildroot}/usr/share/package-licenses/QAT_engine/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
