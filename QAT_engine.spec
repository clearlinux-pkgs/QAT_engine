...
Source0  : https://github.com/intel/QAT_Engine/archive/v1.6.1/QAT_Engine-1.6.1.tar.gz
...
%prep
%setup -q -n QAT_Engine-1.6.1
cd %{_builddir}/QAT_Engine-1.6.1
pushd ..
cp -a QAT_Engine-1.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719331068
