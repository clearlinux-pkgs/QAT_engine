...
Source0  : https://github.com/intel/QAT_Engine/archive/v1.8.0/QAT_Engine-1.8.0.tar.gz
...
%prep
%setup -q -n QAT_Engine-1.8.0
cd %{_builddir}/QAT_Engine-1.8.0
pushd ..
cp -a QAT_Engine-1.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735104182
...
cp %{_builddir}/QAT_Engine-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/QAT_engine/1b1e54603a4ce96a9730c93b2cb45581bdee0758 || :
...
cp %{_builddir}/QAT_Engine-%{version}/LICENSE.PLOCK %{buildroot}/usr/share/package-licenses/QAT_engine/2f6b0c9916cf5833cac96a393039c1f097b853bd || :
...
/usr/share/package-licenses/QAT_engine/1b1e54603a4ce96a9730c93b2cb45581bdee0758
/usr/share/package-licenses/QAT_engine/2f6b0c9916cf5833cac96a393039c1f097b853bd
