...
Source0  : https://github.com/intel/QAT_Engine/archive/v0.6.8/QAT_Engine-0.6.8.tar.gz
...
%prep
%setup -q -n QAT_Engine-0.6.8
cd %{_builddir}/QAT_Engine-0.6.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631910997
...
cp %{_builddir}/QAT_Engine-0.6.8/LICENSE %{buildroot}/usr/share/package-licenses/QAT_engine/57f5309a41a66a8f5d057151c44f987757468164
cp %{_builddir}/QAT_Engine-0.6.8/LICENSE.OPENSSL3.0 %{buildroot}/usr/share/package-licenses/QAT_engine/c5c8a68f4b80929b3e66f054f37bb9e16078847f
cp %{_builddir}/QAT_Engine-0.6.8/qat/LICENSE.GPL %{buildroot}/usr/share/package-licenses/QAT_engine/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/QAT_Engine-0.6.8/qat_contig_mem/LICENSE.GPL %{buildroot}/usr/share/package-licenses/QAT_engine/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
