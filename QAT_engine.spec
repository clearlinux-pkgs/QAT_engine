...
Version  : 0.6.16
Release  : 15
URL      : https://github.com/intel/QAT_Engine/archive/v0.6.16/QAT_Engine-0.6.16.tar.gz
Source0  : https://github.com/intel/QAT_Engine/archive/v0.6.16/QAT_Engine-0.6.16.tar.gz
...
%prep
%setup -q -n QAT_Engine-0.6.16
cd %{_builddir}/QAT_Engine-0.6.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665420953
